#!/usr/bin/env python3
"""
Environment detection and diagnostics module
Automatically detects the Claude-Discord Bridge environment and diagnoses issues
"""
...
class EnvironmentDetector:
    """Class for automatic environment detection and diagnostics"""
    ...
    def _check_token_set(self) -> bool:
        """Check if the Discord token is configured"""
        try:
    ...
    def _get_flask_port(self) -> int:
        """Get the Flask port from configuration"""
        try:
    ...
    def diagnose(self) -> Tuple[bool, List[str]]:
        """Diagnose the environment and list issues"""
        issues = []
